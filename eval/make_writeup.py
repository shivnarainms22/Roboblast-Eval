...
./eval/run_probes.ps1   -Project ../abl                   # anti-cheat suite</code></pre>
  ...
  <div class="callout good">
    ...
    attempted a <code>Bash</code> call</b> and were blocked:
    <code>Error: No such tool available: Bash</code>. The lockdown is enforced in the wild, not merely
    configured. Their solutions are also <b>code-driven</b> while the original is <b>shader-driven</b>,
    and a cheat would have reproduced the shaders. None did, and none recovered the real 3.0 m radius.
  </div>
